...
class requestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        global filename, line_num, header, col_names, start_time, end_time, min_timestamp, max_timestamp
        ...
        for filename in dataverse_files.keys():
            for col_name in col_names:
                if self.path.endswith('.%s.%s' % (filename,col_name)):
                        ...
                        output += '<form> <label for="start_time">Start Time:</label>'
                        output += '<input type="number" id="start_time" name="Start Time" min=%d max=%d>' %(min_timestamp,max_timestamp)
                        output += '&nbsp;&nbsp;&nbsp;&nbsp;'
                        output += '<label for="end_time">End Time:</label>'
                        output += '<input type="number" id="end_time" name="End Time">'
