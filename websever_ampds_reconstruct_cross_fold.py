                ...
                if contain_column:
                    ...
                    if len(file_list_input) <2:
                        ...
                        if common(self_path_list, "*"):
                            ...
                            cross_fold_integer = int(self_path_list[-1])
                            ...
                            if isinstance(cross_fold_integer, int) == True: #if testing with string, there will be a ValueError: invalid literal for int() with base 10
                                ...
                                # print("total_line: " + str(total_line)) # 524543
                                # print("individual_line: " + str(individual_line)) 
                                ...
                                ## test to see the element in the list is an integer
                                print(type(cross_fold_list[1]))
                                print(type(cross_fold_list))


                                column_selected_TS['Cross Fold'] = cross_fold_list
                                df2 = column_selected_TS.to_string(index=False)
